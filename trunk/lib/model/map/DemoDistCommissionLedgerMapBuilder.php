...
class DemoDistCommissionLedgerMapBuilder {

	
	const CLASS_NAME = 'lib.model.map.DemoDistCommissionLedgerMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('demo_dist_commission_ledger');
		$tMap->setPhpName('DemoDistCommissionLedger');
