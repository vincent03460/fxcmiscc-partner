...
<script type="text/javascript" language="javascript">
    ...
    $(function() {
        datagrid = $("#datagrid").r9jasonDataTable({
                    ...
                    "bServerSide": true,
                    "bAutoWidth": false,
                    "sAjaxSource": "/finance/currentLogList",
...
<div class="row">
    <div class="col-md-12">
        <h2 class="page-title"><?php echo __("Current Account Log"); ?>
            <small></small>
        </h2>
    </div>
</div>
        ...
        <section class="widget">
            <header>
                <h4>
                    ...
                    <?php echo __("Current Account Transaction Log"); ?>
                    <small></small>
                </h4>
            </header>
            <div class="body">
                <fieldset>
                    <legend class="section">
                        <?php echo __("Current Account Log")?>
                    </legend>
                            ...
                            <section class="widget">
                                <header>
                                    <h4>
                                        ...
                                        <?php echo __("Current Account Listing")?>
                                    </h4>
                                </header>
                                <div class="body">
                                    <div>
