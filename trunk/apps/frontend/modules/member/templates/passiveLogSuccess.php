...
<script type="text/javascript" language="javascript">
    ...
    $(function() {
        datagrid = $("#datagrid").r9jasonDataTable({
                    ...
                    "bServerSide": true,
                    "bAutoWidth": false,
                    "sAjaxSource": "/finance/passiveLogList",
...
<div class="title">
  <h1><?php echo __("Passive Wallet Log"); ?></h1>
</div>
<div class="table">
    ...
    <tr>
      <td width="100%">
        <table cellpadding="0" cellspacing="0" width="100%">
          <tr>
            <th colspan="2"><?php echo __("Passive Wallet Transaction Log")?></th>
          </tr>
          <tr>
            <td class="tablebg">
              ...
              <fieldset>
                ...
                <section class="widget" style="background: none;">
                  <header>
                    ...
                    <?php echo __("Passive Wallet Listing")?>
                    <br/><br/>
                  </header>
                  <div class="body">
                    <div>
