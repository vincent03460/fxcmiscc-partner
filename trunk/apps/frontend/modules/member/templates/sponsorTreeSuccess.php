...
<div class="title">
  <h1><?php echo __("Sponsor Genealogy"); ?></h1>
</div>
<div class="table">
    ...
    <tr>
      <td width="100%">
        <table cellpadding="0" cellspacing="0" width="100%">
          <tr>
            <th colspan="2"><?php echo __("Sponsor Genealogy")?></th>
          </tr>
          <tr>
            <td class="tablebg">
              <i class="icon-ok-sign"></i>
              <?php echo __("Search member from your genealogy"); ?>
              <small></small>
              <br/><br/>
              ...
              <form class="form-horizontal label-left" method="post"
                ...
                <div class="form-actions">
                  <button type="button" id="btnSubmit" class="btn btn-primary"><?php echo __("Search");?></button>
