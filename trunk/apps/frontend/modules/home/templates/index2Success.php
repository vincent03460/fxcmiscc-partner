        ...
        <div id="content">
            ...
            <!--<div class="slider-nivo-holder">
                <div class="nivoSlider" style="position: relative; no-repeat scroll 0% 0% transparent;" id="slider-nivo">
                    <img style="display: none;" src="/css/pages/main-slide-01.png" alt="">
                    <img style="display: none;" src="/css/pages/main-slide-02.png" alt="">
                    <img style="display: none;" src="/css/pages/main-slide-03.png" alt="">
                </div>
            </div>
...
#banner .nav li a.activeSlide {
    color: #333438;
            ...
            <div id="banner">
                <ol class="slides" style="position: relative; overflow: hidden;">
                    ...
                    <!--<li class="slide-content hide"
                        ...
                        <link type="text/css" rel="stylesheet" href="/css/pages/g3bo.css">
                        <div id="g3boBody">
                            <div id="g3boContent">
                                <h3 style="color: #FFFFFF;"><?php /*echo __('SIXSTAR') */?></h3>
                                ...
                                <a title="open a trial account" href="/member/register"
                                   class="g3boButton"><?php /*echo __('OPEN AN ACCOUNT NOW') */?><img
                                        src="/css/pages/button arrow.png"
                                        alt=""></a>
                            </div>
                        </div>-->
                        <!--<div id="flashContent">
                            <object align="middle" width="940" height="405"
                                    id="/css/pages/banner/ActiveTrader_Homepage_001_fla5"
                                    classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000">
                                <param value="/css/pages/banner/ActiveTrader_Homepage_001_fla5.swf"
                                       name="movie">
                                ...
                                <!--<object width="940" height="405" type="application/x-shockwave-flash"
                                        data="/css/pages/banner/ActiveTrader_Homepage_001_fla5.swf">
                                    <param value="/css/pages/banner/ActiveTrader_Homepage_001_fla5.swf"
                                           name="movie">
                                    <param value="high" name="quality">
                                    <param value="#ffffff" name="bgcolor">
                                    ...
                                    <!--<![endif]-->
                                    <!--<img
                                        src="/css/pages/G3BO_HomepageSlideshow_Background.jpg"
                                        alt="">--> <!--[if !IE]>-->
                        <!--</object>-->
                                <!--<![endif]-->
                        <!--</object>
                        ...
                        <div class="altImage">
                            <img src="/css/pages/G3BO_HomepageSlideshow_Background.jpg" alt="">
                    ...
                    <li class="slide-content hide"
                        ...
                        <div class="slide-content"
                             style="background:#f6f7f6 url('/css/pages/banner/bg3.png') left top no-repeat;width:582px;height:212px;">
                        </div>
                    </li>
            ...
            <div class="hr2"></div>
            <a href="<?php echo url_for("/home/maximExecutor")?>"><p><img width="582" height="184" src="/css/pages/banner/banner-08.jpg" alt="" title="MAXIMTRADE EXECUTOR™" class="aligncenter size-full wp-image-162"></p></a>
            ...
            <div class="hr2"></div>
            <a href="<?php echo url_for("/home/maximExecutor")?>"><p><img width="582" height="184" src="/css/pages/banner/bg2.png" alt="" title="MAXIMTRADE EXECUTOR™" class="aligncenter size-full wp-image-162"></p></a>

            <!--^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^-->
            <!--<div class="hr2"></div>
            <div class="one_half"><span class="medium_image"
                                        style="float: left; margin-bottom: 10px; margin-right: 20px;"><a class=""><img
                    style="visibility: visible; opacity: 1;" src="/css/pages/small-img-1.png" alt=""
            ...
            <div class="one_half_last"><span class="medium_image"
                    ...
                    class=""><img style="visibility: visible; opacity: 1;" src="/css/pages/small-img-3.png"
                                  alt="" height="128" width="272"></a></span> <strong>Investment Report</strong>
                We estimate that SIXSTAR investment portfolios have outperformed
            ...
            <!--<div class="one_half"><span class="medium_image"
                                        style="float: left; margin-bottom: 10px; margin-right: 20px;"><a class=""><img
                    style="visibility: visible; opacity: 1;" src="/css/pages/small-img-4.png" alt=""
            ...
            <div class="one_half_last"><span class="medium_image"
                                             style="float: left; margin-bottom: 10px; margin-right: 20px;"><a
                    class=""><img style="visibility: visible; opacity: 1;" src="/css/pages/small-img-2.png"
