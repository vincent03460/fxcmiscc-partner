...
abstract class BaseDemoDistCommissionLedger extends BaseObject  implements Persistent {
	...
	public function setCommissionId($v)
	{
		...
		if ($this->commission_id !== $v) {
			...
			$this->modifiedColumns[] = DemoDistCommissionLedgerPeer::COMMISSION_ID;
		}
	...
	public function setDistId($v)
	{
		...
		if ($this->dist_id !== $v) {
			$this->dist_id = $v;
			$this->modifiedColumns[] = DemoDistCommissionLedgerPeer::DIST_ID;
		}
	...
	public function setCommissionType($v)
	{
		...
		if ($this->commission_type !== $v) {
			...
			$this->modifiedColumns[] = DemoDistCommissionLedgerPeer::COMMISSION_TYPE;
		}
	...
	public function setTransactionType($v)
	{
		...
		if ($this->transaction_type !== $v) {
			...
			$this->modifiedColumns[] = DemoDistCommissionLedgerPeer::TRANSACTION_TYPE;
		}
	...
	public function setRefId($v)
	{
		...
		if ($this->ref_id !== $v) {
			$this->ref_id = $v;
			$this->modifiedColumns[] = DemoDistCommissionLedgerPeer::REF_ID;
		}
	...
	public function setMonthTraded($v)
	{
		...
		if ($this->month_traded !== $v) {
			$this->month_traded = $v;
			$this->modifiedColumns[] = DemoDistCommissionLedgerPeer::MONTH_TRADED;
		}
	...
	public function setYearTraded($v)
	{
		...
		if ($this->year_traded !== $v) {
			$this->year_traded = $v;
			$this->modifiedColumns[] = DemoDistCommissionLedgerPeer::YEAR_TRADED;
		}
	...
	public function setCredit($v)
	{
		...
		if ($this->credit !== $v || $v === 0) {
			$this->credit = $v;
			$this->modifiedColumns[] = DemoDistCommissionLedgerPeer::CREDIT;
		}
	...
	public function setDebit($v)
	{
		...
		if ($this->debit !== $v || $v === 0) {
			$this->debit = $v;
			$this->modifiedColumns[] = DemoDistCommissionLedgerPeer::DEBIT;
		}
	...
	public function setBalance($v)
	{
		...
		if ($this->balance !== $v || $v === 0) {
			$this->balance = $v;
			$this->modifiedColumns[] = DemoDistCommissionLedgerPeer::BALANCE;
		}
	...
	public function setRemark($v)
	{
		...
		if ($this->remark !== $v) {
			$this->remark = $v;
			$this->modifiedColumns[] = DemoDistCommissionLedgerPeer::REMARK;
		}
	...
	public function setPipsDownlineUsername($v)
	{
		...
		if ($this->pips_downline_username !== $v) {
			...
			$this->modifiedColumns[] = DemoDistCommissionLedgerPeer::PIPS_DOWNLINE_USERNAME;
		}
	...
	public function setPipsMt4Id($v)
	{
		...
		if ($this->pips_mt4_id !== $v) {
			$this->pips_mt4_id = $v;
			$this->modifiedColumns[] = DemoDistCommissionLedgerPeer::PIPS_MT4_ID;
		}
	...
	public function setPipsRebate($v)
	{
		...
		if ($this->pips_rebate !== $v) {
			$this->pips_rebate = $v;
			$this->modifiedColumns[] = DemoDistCommissionLedgerPeer::PIPS_REBATE;
		}
	...
	public function setPipsLevel($v)
	{
		...
		if ($this->pips_level !== $v) {
			$this->pips_level = $v;
			$this->modifiedColumns[] = DemoDistCommissionLedgerPeer::PIPS_LEVEL;
		}
	...
	public function setPipsLotsTraded($v)
	{
		...
		if ($this->pips_lots_traded !== $v) {
			...
			$this->modifiedColumns[] = DemoDistCommissionLedgerPeer::PIPS_LOTS_TRADED;
		}
	...
	public function setCreatedBy($v)
	{
		...
		if ($this->created_by !== $v) {
			$this->created_by = $v;
			$this->modifiedColumns[] = DemoDistCommissionLedgerPeer::CREATED_BY;
		}
	...
	public function setCreatedOn($v)
	{
		...
		if ($this->created_on !== $ts) {
			$this->created_on = $ts;
			$this->modifiedColumns[] = DemoDistCommissionLedgerPeer::CREATED_ON;
		}
	...
	public function setUpdatedBy($v)
	{
		...
		if ($this->updated_by !== $v) {
			$this->updated_by = $v;
			$this->modifiedColumns[] = DemoDistCommissionLedgerPeer::UPDATED_BY;
		}
	...
	public function setUpdatedOn($v)
	{
		...
		if ($this->updated_on !== $ts) {
			$this->updated_on = $ts;
			$this->modifiedColumns[] = DemoDistCommissionLedgerPeer::UPDATED_ON;
		}
	...
	public function setStatusCode($v)
	{
		...
		if ($this->status_code !== $v) {
			$this->status_code = $v;
			$this->modifiedColumns[] = DemoDistCommissionLedgerPeer::STATUS_CODE;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			throw new PropelException("Error populating DemoDistCommissionLedger object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			DemoDistCommissionLedgerPeer::doDelete($this, $con);
	...
	{
    if ($this->isNew() && !$this->isColumnModified(DemoDistCommissionLedgerPeer::CREATED_ON))
    {
      $this->setCreatedOn(time());
    }

    if ($this->isModified() && !$this->isColumnModified(DemoDistCommissionLedgerPeer::UPDATED_ON))
    {
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = DemoDistCommissionLedgerPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setCommissionId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += DemoDistCommissionLedgerPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = DemoDistCommissionLedgerPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = DemoDistCommissionLedgerPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = DemoDistCommissionLedgerPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(DemoDistCommissionLedgerPeer::COMMISSION_ID)) $criteria->add(DemoDistCommissionLedgerPeer::COMMISSION_ID, $this->commission_id);
		if ($this->isColumnModified(DemoDistCommissionLedgerPeer::DIST_ID)) $criteria->add(DemoDistCommissionLedgerPeer::DIST_ID, $this->dist_id);
		if ($this->isColumnModified(DemoDistCommissionLedgerPeer::COMMISSION_TYPE)) $criteria->add(DemoDistCommissionLedgerPeer::COMMISSION_TYPE, $this->commission_type);
		if ($this->isColumnModified(DemoDistCommissionLedgerPeer::TRANSACTION_TYPE)) $criteria->add(DemoDistCommissionLedgerPeer::TRANSACTION_TYPE, $this->transaction_type);
		if ($this->isColumnModified(DemoDistCommissionLedgerPeer::REF_ID)) $criteria->add(DemoDistCommissionLedgerPeer::REF_ID, $this->ref_id);
		if ($this->isColumnModified(DemoDistCommissionLedgerPeer::MONTH_TRADED)) $criteria->add(DemoDistCommissionLedgerPeer::MONTH_TRADED, $this->month_traded);
		if ($this->isColumnModified(DemoDistCommissionLedgerPeer::YEAR_TRADED)) $criteria->add(DemoDistCommissionLedgerPeer::YEAR_TRADED, $this->year_traded);
		if ($this->isColumnModified(DemoDistCommissionLedgerPeer::CREDIT)) $criteria->add(DemoDistCommissionLedgerPeer::CREDIT, $this->credit);
		if ($this->isColumnModified(DemoDistCommissionLedgerPeer::DEBIT)) $criteria->add(DemoDistCommissionLedgerPeer::DEBIT, $this->debit);
		if ($this->isColumnModified(DemoDistCommissionLedgerPeer::BALANCE)) $criteria->add(DemoDistCommissionLedgerPeer::BALANCE, $this->balance);
		if ($this->isColumnModified(DemoDistCommissionLedgerPeer::REMARK)) $criteria->add(DemoDistCommissionLedgerPeer::REMARK, $this->remark);
		if ($this->isColumnModified(DemoDistCommissionLedgerPeer::PIPS_DOWNLINE_USERNAME)) $criteria->add(DemoDistCommissionLedgerPeer::PIPS_DOWNLINE_USERNAME, $this->pips_downline_username);
		if ($this->isColumnModified(DemoDistCommissionLedgerPeer::PIPS_MT4_ID)) $criteria->add(DemoDistCommissionLedgerPeer::PIPS_MT4_ID, $this->pips_mt4_id);
		if ($this->isColumnModified(DemoDistCommissionLedgerPeer::PIPS_REBATE)) $criteria->add(DemoDistCommissionLedgerPeer::PIPS_REBATE, $this->pips_rebate);
		if ($this->isColumnModified(DemoDistCommissionLedgerPeer::PIPS_LEVEL)) $criteria->add(DemoDistCommissionLedgerPeer::PIPS_LEVEL, $this->pips_level);
		if ($this->isColumnModified(DemoDistCommissionLedgerPeer::PIPS_LOTS_TRADED)) $criteria->add(DemoDistCommissionLedgerPeer::PIPS_LOTS_TRADED, $this->pips_lots_traded);
		if ($this->isColumnModified(DemoDistCommissionLedgerPeer::CREATED_BY)) $criteria->add(DemoDistCommissionLedgerPeer::CREATED_BY, $this->created_by);
		if ($this->isColumnModified(DemoDistCommissionLedgerPeer::CREATED_ON)) $criteria->add(DemoDistCommissionLedgerPeer::CREATED_ON, $this->created_on);
		if ($this->isColumnModified(DemoDistCommissionLedgerPeer::UPDATED_BY)) $criteria->add(DemoDistCommissionLedgerPeer::UPDATED_BY, $this->updated_by);
		if ($this->isColumnModified(DemoDistCommissionLedgerPeer::UPDATED_ON)) $criteria->add(DemoDistCommissionLedgerPeer::UPDATED_ON, $this->updated_on);
		if ($this->isColumnModified(DemoDistCommissionLedgerPeer::STATUS_CODE)) $criteria->add(DemoDistCommissionLedgerPeer::STATUS_CODE, $this->status_code);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(DemoDistCommissionLedgerPeer::COMMISSION_ID, $this->commission_id);
	...
	{
		if (self::$peer === null) {
			self::$peer = new DemoDistCommissionLedgerPeer();
		}
		return self::$peer;
	}
