...
$(function(){
		...
		"aoColumns": [
		              ...
		              { "sName" : "dist.distributor_id",  "bSortable": false, "fnRender": function ( oObj ) {
                          ...
                          $("#dgAddPanel").data("data_" + oObj.aData[0], {
                                ...
                                , register_remark : oObj.aData[idx++]
                          });
                    ...
                    { "sName" : "dist.register_remark",  "bVisible": false}
		]
	});
    ...
    $("#btnExport").button({
        ...
        event.preventDefault();
        window.open("<?php echo url_for("marketing/distListInDetail")?>?filterDistcode=" + $("#search_distCode").val() + "&filterMt4Username=" + $("#search_mt4Username").val() + "&filterFullName=" + $("#search_fullName").val() + "&filterEmail=" + $("#search_email").val() + "&filterParentCode=" + $("#search_parentCode").val() + "&filterStatusCode=" + $("#search_statusCode").val());
    });
}); // end $(function())
            ...
            Submit: function() {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        , bank_branch : $('#dgAddPanelBankBranch').val()
...
function populateDgAddPanel() {
    ...
    if ($("#dgAddPanelId").val() == "") {
        ...
        $("#dgAddPanelBankAddress").val(data.bank_address);
        $("#dgAddPanelBankBranch").val(data.bank_branch);
        $("#dgAddPanelRemark").val(data.remark);
        $("#dgAddPanelRegisterRemark").val(data.register_remark);
    }
}
</script>
<div id="dgAddPanel" style="display:none; width: 850px" title="User">
    ...
    <table cellpadding="3" cellspacing="3">
        ...
        <tr>
            <td>Bank Address</td>
            <td>:</td>
            <td><input type="text" id="dgAddPanelBankAddress" class="text ui-widget-content ui-corner-all" size="25"></td>
            <td>Bank Branch</td>
            <td>:</td>
            <td><input type="text" id="dgAddPanelBankBranch" class="text ui-widget-content ui-corner-all" size="25"></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>:</td>
            <td colspan="4"><textarea id="dgAddPanelRegisterRemark" class="text ui-widget-content ui-corner-all" rows="2" cols="60"></textarea></td>
        </tr>
    </table>
    </fieldset>
</div>
