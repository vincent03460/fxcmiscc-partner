...
$(function(){
    $("#uploadForm").validate({
        messages : {
            file_upload: {
                accept: "Please select a XLS File (*.xls)"
            }
        },
        rules : {
            "file_upload" : {
    ...
    $("#btnSubmit").button({
        ...
        $("#uploadForm").attr("action", "<?php echo url_for("/marketing/doDemoUploadPips")?>");
        $("#doAction").val("upload");
    });
    ...
    $("#btnShowPipsData").button({
        ...
        $("#uploadForm").attr("action", "<?php echo url_for("/marketing/demoPipsUpload")?>");
...
<?php echo form_tag('marketing/doDemoUploadPips', array("enctype" => "multipart/form-data", "id" => "uploadForm")) ?>
<input type="hidden" name="doAction" id="doAction">
<div style="padding: 10px; top: 30px; position: absolute; width: 1100px">
<div class="portlet">
    <div class="portlet-header">Pips Upload (Demo)</div>
...
$(function(){
    datagrid = $("#datagrid").r9jasonDataTable({
        ...
        "bServerSide": true,
        "bAutoWidth": false,
        "sAjaxSource": "<?php echo url_for('financeList/demoPipsBonusList') ?>",
    ...
    <div>
        <font style="font-weight: bold; font-size: large; color: red">Total Pips Bonus : <?php echo $totalPipsBonus;?></font>
        <br>
