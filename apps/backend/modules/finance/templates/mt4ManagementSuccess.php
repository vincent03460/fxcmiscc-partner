...
$(function() {
    ...
    $("#btnSubmit").button().click(function(event){
        ...
        var amount = $('#mt4Amount').autoNumericGet();
...
<div style="padding: 10px; top: 30px; position: absolute; width: 1000px">
    <div class="portlet">
        <div class="portlet-header"><?php echo __('MT4 Management') ?></div>
        <div class="portlet-content">
            <div id="divPIPS">
                <table class="display" id="datagridByMonth" border="0" width="100%">
                    ...
                    <tr>
                        <td class="caption" style="width: 25%">MT4</td>
                        <td class="value">
                            <input type="text" name="mt4Amount" id="mt4Amount" value="0" size="20">
                        </td>
                    </tr>
                    <tr>
                ...
                $(function() {
                    ...
                    walletDatagrid = $("#walletDatagrid").r9jasonDataTable({
                        ...
                        "extraParam" : function(aoData) { // pass extra params to server
                            aoData.push({ "name": "filterSearch_walletType", "value": "MT4"  });
