...
<div class="breadcrumbs" id="breadcrumbs">
    <script type="text/javascript">
        ...
        $(function($) {
            datagrid = $("#datagrid").r9jasonDataTable({
                ...
                "bServerSide": true,
                "bAutoWidth": false,
                "sAjaxSource": "/business/inactiveMemberList",
    ...
    <ul class="breadcrumb">
        ...
        <li class="active">In-active Member List</li>
    </ul>
    <!-- .breadcrumb -->
...
<div class="row">
<div class="col-xs-12">
<h3 class="header smaller lighter green"><?php echo __('In-active Member List') ?></h3>
<!-- PAGE CONTENT BEGINS -->
...
<div class="col-xs-12">
    <div class="table-header">
        Results for "In-active Member List"
    </div>
