...
<form action="/member/placementTree" id="transferForm" method="post">
    ...
    <input type="hidden" name="p" id="<?php echo $pageDirection; ?>">
        ...
        <tr>
            ...
            foreach ($packageDBs as $package) {

            ?>
            <td><img height="30px" src="/css/network/<?php echo $package->getColor(); ?>_head.png"><?php echo $package->getPackageName();?></td>
            <? } ?>
        </tr>
    </table>
<br>
...
<?php
    ...
    if ($distCode != "") {
        ...
        $classAndAttr .= " distCode='".$distCode." (".$fullName.")'";
