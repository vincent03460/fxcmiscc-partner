...
<head>
    ...
    <link rel='stylesheet' id='styler-farbtastic-css' href='/css/pages/styler-farbtastic.css' type='text/css'
          media='all'/>
    ...
    <div style="display: inline; width: 666px; overflow: hidden; margin-right: 0px;" id="page">
        <div id="content">
            ...
            <div><img width="582" title="small-img-5" alt=""
                      src="/css/pages/banner/banner-09.jpg"></div>

            <p align="justify"><strong><?php echo __('Consortium by SIXSTAR') ?></strong>. <?php echo __('Consortium is the latest project undertaken by SIXSTAR to develop a cooperative for financial leverage with a pioneering inclusion of third party individuals.') ?></p>
            ...
            <p align="justify">
                <strong><?php echo __('Where SIXSTAR steps in') ?></strong>
                <br>
            ...
            <p align="justify">
                <?php echo __('This is why the considerable resources of SIXSTAR is combined with those of its clients/shareholders; enlarging the capital base of both to profit from the immerse opportunities the financial markets of the day has to offer – the currency market.') ?>
            </p>

            <h2><?php echo __('Creating Value Added') ?></h2>
            <p align="justify">
                <?php echo __('With the vast selection of platforms out there, the question here is \'why choose SIXSTAR?\' An intelligent client always seeks to get his money\'s worth and such is the inspiration behind the \'Consortium Model\'.') ?>
                <br>
                <br>
                <strong>•	<?php echo __('State-of-the art trading technology') ?></strong>
                <br>
                <?php echo __('Maximtrade™ Executor is our proprietary algorithmic trade technology, which is the outcome of SIXSTAR\'s research efforts over the last couple of years. Although the major experimenting, modification and enhancement has concluded, SIXSTAR is constantly monitoring performance for optimum trade productivity. We are proud to say that we will be offering Maximtrade™ Executor to our clients. A manumatic operating system that inputs SIXSTAR\'s trading expertise into your system while allowing you enough flexibility to make your own trading decisions.') ?>
                <br>
                <br>
                <strong>•	<?php echo __('Capital enhancement') ?></strong>
                <br>
                <?php echo __('In line with resource pooling, SIXSTAR will match clients\' capital up to a maximum bonus of a dollar to dollar capital enhancement. This also means that you could have up to twice your original capital working for you. The reason for this is simple. With the Maximtrade™ Executor, more profits are generated not only for you, but for the company as well. Moreover, we take the risk with you so you can have peace of mind that we will do our utmost to ensure positive results.') ?>
                <br>
                <br>
                <strong>•	<?php echo __('Our confidence') ?></strong>
                <br>
                <?php echo __('All clients fund are individually and severally insured in the form of a parental guarantee provided by our parent company MY Group Inc. Specifically, every dollar invested by our client is backed by a corresponding share of the parent company. With this unique arrangement, investors have the comfort and knowledge that in the unlikely event of insolvency of SIXSTAR, they have in their hands the shares of a public listed company in which they can use to mitigate such risks.') ?>
                <br>
                <br>
                <strong><?php echo __('Sustained Profits') ?></strong>
                <br>
                <?php echo __('With the two key elements in place, leverage through resource pooling and an automated trading machine, SIXSTAR is able to achieve even greater revenue that what is has been generating stably over the decade. As our system produced profits for you, it is simultaneously producing profits off you because SIXSTAR achieves revenue through the number of lots traded. This creates a win-win situation through a fair system that yields profits for both parties.') ?>
                <br>
                <strong><?php echo __('Cashback Rewards') ?></strong>
                <br>
                <?php echo __('SIXSTAR gives credit where credit is due, often in the form of monetary rewards and incentives for our affiliates. The increase in revenue allows liquidity to be channeled towards marketing campaigns that will evidently generate more leads and business back to SIXSTAR. Our clients are happy, our affiliates are rewarded and company expands.') ?>
                <br>
            ...
            <p align="justify"><strong><?php echo __('What SIXSTAR Offer') ?></strong>
                <br>
                <?php echo __('Your potential income at SIXSTAR is broadly defined in 3 main categories : Trade income, Entry package entitlements and Affiliate bonuses. This is a non exhaustive representation due to seasonal promotions and rewards through performance indicators.') ?>
                </p>

            <p align="justify"><strong><?php echo __('Trade Income') ?></strong>
                <br>
                <?php echo __('With SIXSTAR, your basic income is derived from the profits generated by the trades that our fund management or algorithmic software executes. In addition, you have the full freedom to apply your own trading techniques and generate profits from trading as well.') ?>
                </p>

            <p align="justify"><strong><?php echo __('Entry Package entitlements') ?></strong>
                <br>
                <?php echo __('SIXSTAR Financial offers you at attractive array of entry packages to benefit from our proprietary trading system. The entitlements derived purely from becoming a member have a value that far outweighs the costs. This income is your entitlement as a member.') ?>
                </p>
